...
const UTM = "utm_source=mainstreet-demo&utm_medium=site-strip&utm_campaign=emdash-themes";

// Superhero Technologies brand violet (#5933d8, their declared
// theme-color), deepened for the strip ground.
const STRIP_HTML = `
<aside style="background:#170b3d;border-top:2px solid #5933d8;color:#cfc3f5;font-family:'Plus Jakarta Sans',-apple-system,sans-serif;font-size:13.5px;line-height:1.5;">
	<div style="max-width:1200px;margin:0 auto;padding:14px 24px;display:flex;flex-wrap:wrap;gap:8px 24px;align-items:center;justify-content:space-between;">
		<span>
			...
			<a href="https://github.com/ecropolis/emdash-theme-mainstreet" style="color:#fff;font-weight:600;text-decoration:underline;text-underline-offset:2px;">Mainstreet</a>,

...
const PRESETS: Record<string, { label: string; brandLight: string; brandDark: string; accent: string }> = {
	sage: { label: "Sage & Amber (theme default)", brandLight: "#0f766e", brandDark: "#2dd4bf", accent: "#d97706" },
...
const FONTS = [
	{ label: "Theme default (Plus Jakarta Sans)", value: "default" },
					...
					]),
			{
				...
				fields: [
					...
					},
					{
						...
						options: [
							{ label: "Bold (theme default)", value: "700" },
